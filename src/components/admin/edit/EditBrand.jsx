...
const EditBrand = (props) => {
    ...
    const onSubmitHandler = async (e) => {
        e.preventDefault()
        await axios.post(`https://sport-mix.uz/backend/brand/updateBrand.php?id=${id}`, brand);
        console.log(brand);
    ...
    const loadBrand = async (id) => {
        const result = await axios.get(`https://sport-mix.uz/backend/brand/getByIdBrand.php?id=${id}`)
